...
meaning that proofs are verified against
...
The main facts regarding Shamir's sharing
...
security is (most probably)
not provable without further assumptions as well.
In particular,
...
by definition of weights (cf. Definition \ref{orst_weights_definition}) we get
